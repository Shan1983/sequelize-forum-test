...
module.exports = (sequelize, DataTypes) => {
  ...
  User.prototype.updatePassword = async (currentPassword, newPassword) => {
    ...
    const correctPassword = await bcrypt.compare(currentPassword, this.hash);
  ...
  User.prototype.getMeta = async limit => {
  ...
  User.prototype.includeOptions = (from, limit) => {
  ...
  User.prototype.canBeAdmin = async token => {
  ...
  User.hook("afterValidate", async (user, options) => {
